...
if id "zealium8" >/dev/null 2>&1; then
echo -e ${YELLOW} "Found user zealium8!"${CLEAR}
MN8=1
else
sudo adduser --system --home /home/zealium8 zealium8
MN8=0
fi
echo
echo
...
echo
if [ ! -f /home/zealium8/.zealium/zealium.conf ]; then
if [ ! -f /home/zealium8/zealium.conf ]; then
echo -e "${GREEN}Eigth Zealium Node Configuration Not Found....${CLEAR}"
echo -e "${YELLOW}Configuring Eigth Zealium Node${CLEAR}"
sudo mkdir /home/zealium8/.zealium
sudo touch /home/zealium8/zealium.conf
echo "rpcuser=user"`shuf -i 100000-9999999 -n 1` >> /home/zealium8/zealium.conf
echo "rpcpassword=pass"`shuf -i 100000-9999999 -n 1` >> /home/zealium8/zealium.conf
echo "rpcallowip=127.0.0.1" >> /home/zealium8/zealium.conf
echo "server=1" >> /home/zealium8/zealium.conf
echo "daemon=1" >> /home/zealium8/zealium.conf
echo "maxconnections=250" >> /home/zealium8/zealium.conf
echo "masternode=1" >> /home/zealium8/zealium.conf
echo "rpcport=19089" >> /home/zealium8/zealium.conf
echo "listen=0" >> /home/zealium8/zealium.conf
echo "externalip=[${MNIP8}]:31090" >> /home/zealium8/zealium.conf
echo "masternodeprivkey=$MNKEY8" >> /home/zealium8/zealium.conf
if [[ $NULLREC = "y" ]] ; then
echo "masterNode8 : true" >> /usr/local/nullentrydev/nzl.log
echo "walletVersion8 : 1.0.1.2" >> /usr/local/nullentrydev/nzl.log
echo "scriptVersion8 : 0.99" >> /usr/local/nullentrydev/nzl.log
fi
else
echo
echo -e ${YELLOW}"Found /home/zealium8/zealium.conf"${CLEAR}
echo -e ${YELLOW}"Skipping Pre-stage for Eigth Node "${CLEAR}
MN8=0
fi
else
echo -e ${YELLOW}"Found /home/zealium8/.zealium/zealium.conf"${CLEAR}
...
if [[ "$MN8" -eq "0" ]]; then
sudo cp -r /home/zealium1/.zealium/* /home/zealium8/.zealium
rm /home/zealium8/.zealium/zealium.conf
cp -r /home/zealium8/zealium.conf /home/zealium8/.zealium/zealium.conf
sleep 1
fi
echo -e ${YELLOW}"Launching First NZL Node"${CLEAR}
zealiumd -datadir=/home/zealium1/.zealium -daemon
...
sleep 20
echo -e ${YELLOW}"Launching Eigth NZL Node"${CLEAR}
zealiumd -datadir=/home/zealium8/.zealium -daemon
sleep 20
...
echo -e "${YELLOW}For mn8: \"zealium-cli -datadir=/home/zealium8/.zealium masternode status\""${CLEAR}
echo
...
echo -e "${BOLD} Masternode - \#8 IP: [${MNIP8}]:31090${CLEAR}"
fi
